...
class EnvironmentTests(unittest.TestCase):
    def test_all_apps_share_one_local_api(self):
        ...
        self.assertEqual(result["student"]["EXPO_PUBLIC_API_BASE_URL"], "http://127.0.0.1:8000/api")
        for role in ("superuser", "university", "institute"):
            self.assertEqual(result[role]["VITE_API_BASE_URL"], "http://127.0.0.1:8000")
        self.assertEqual(result["backend"]["GITHUB_OAUTH_REDIRECT_URI"], "http://127.0.0.1:8000/api/auth/github/callback/")
