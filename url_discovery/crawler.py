...
class DirectUniversityCrawler:
    ...
    def _prepare_robots(self, client: httpx.Client) -> None:
        ...
        try:
            status, _headers, body, final_url = request_with_policy(
                client, robots_url, self.domain_policy, max_bytes=512 * 1024
            )
            if status >= 400:
    ...
    def _fetch_and_parse(
        ...
        try:
            status_code, headers, body, response_url = request_with_policy(client, url, self.domain_policy)
